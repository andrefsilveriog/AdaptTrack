...
export default function Dashboard() {
  ...
  const exerciseNames = (Array.isArray(profile?.exerciseNames) && profile.exerciseNames.length===3)
  ...
  return (
    <>
      ...
      {derived.length > 0 && (
        ...
        <TrendExplorerChart derived={derived} weekly={weekly} exerciseNames={exerciseNames} cycles={activeCycles} currentCycle={currentCycle} />
          </div>
        </div>
      )}
