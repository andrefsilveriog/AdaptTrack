...
export default function TrendExplorerChart({ derived, weekly, exerciseNames, cycles = [], currentCycle = null }) {
  const safeLiftNames = (Array.isArray(exerciseNames) && exerciseNames.length === 3)
    ? exerciseNames
